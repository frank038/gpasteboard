...
All clipboards are stored in text files, that can be modified with a text editor; because this program store statically the previews internally, after a modification of that files, this program needs to be restarted to update its content.
